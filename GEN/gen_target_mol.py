...
class Options:
    def __init__(self,
                 ...
                 latent_size=56,
                 depth=3,
                 jtnn_model_path="jtvae/molvae/MPNVAE-h450-L56-d3-beta0.005/model.iter-4",
...
def decode(jtvae_path_tuple,
    ...
    path_A_to_B = os.path.join(data_path, file_to_encode)
    save_path_A_to_B = os.path.join(data_path, save_name)
    ...
    df_to_save_A_to_B.dropna(axis=0, how="any", inplace=True)
...
def main():
    ...
    parser.add_argument("--data_path", default="./result/rings/3/")
    parser.add_argument("--file_to_encode", default="new.csv")
    parser.add_argument("--save_name", default="exp1_decode")
